...
from .views import (
    CourseViewSet, LessonListView, LessonRetrieveView, LessonCreateView,
    LessonUpdateView, LessonDestroyView, PaymentCreateView, PaymentStatusView,
...
urlpatterns = [
    ...
    path('payments/success/<str:pk>/', PaymentSuccessView.as_view(), name='payment-success'),
